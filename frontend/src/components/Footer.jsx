  ...
  return (
    <div className='w-[100%] md:h-[36vh] h-[21vh] mb-[77px] md:mb-[0px]'>
        ...
        flex items-center justify-center md:px-[50px] px-[5px]'>
            <div className='md:w-[30%] w-[35%] h-[100%] flex justify-center
            flex-col gap-[5px]'>
                <div className='flex items-start justify-start gap-[5px] mt-[10px] md:mt-[40px]'>
                 ...
                 <p className='text-[15px] text-[#1e2223] hidden md:block'>
                        ...
                        products, unbeatable deals, and fast delievery-all backed by trusted service 
                        design to make your life easier every day.
                    </p>
                    <p className='text-[15px] text-[#1e2223] flex md:hidden'>
                        Fast. Easy. Reliable. OneCart. Shopping
                    </p>
            </div>
                <div className='md:w-[25%] w-[30%] h-[100%] flex items-center justify-center flex-col
                text-center'>
                    ...
                    <ul>
                        ...
                        <li className='text-[15px] text-[#1e2223] hidden md:block cursor-pointer'>Deleivery</li>
                ...
                <div className='md:w-[25%] w-[40%] h-[100%] flex items-center justify-center flex-col text-center'>
                    ...
                    <ul>
                        <li className='text-[15px] text-[#1e2223] hidden md:block cursor-pointer'>+91-8929617693</li>
        ...
        <div className='w-[100%] h-[2px] bg-slate-800'>
            <div className='w-[100%] h-[6vh] bg-[#dbfcfcec] flex items-center justify-center'>
                Copyright 2025@onecart.com-All Right Reserved.</div>
        </div>
    </div>
  )
}
