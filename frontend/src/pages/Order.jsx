...
const Order = () => {
  ...
  return (
    <div className='w-[99vw] min-h-[100vh] p-[20px] pb-[150px] overflow-hidden bg-gradient-to-l
                        ...
                        py-[10px] px-[20px] rounded-2xl relative'>
                            ...
                            <div className='flex items-start justify-center flex-col gap-[5px]'>
                                ...
                                <div className='flex items-center gap-[8px] md:gap-[20px]'>
                                    ...
                                    {item.price}</p>
                                    <p className='md:text-[18px] text-[12px] text-[#aaf4e7]'>Quantity:
                                    {item.quantity}</p>
                                    <p className='md:text-[18px] text-[12px] text-[#aaf4e7]'>Size:
                                    {item.size}</p> 
                                </div>
                                <div className='flex items-center'>
                                    <p className='md:text-[18px] text-[12px] text-[#aaf4e7]'>Date:
                                    <span className='text-[#efbff] pl-[10px] md:text-[16px] text-[11px]'>
                                ...
                                <div className='absolute md:right-[5%] right-[2%] md:top-[40%] top-[65%]'>
                                    <button className='px-[15px] py-[7px] rounded-md bg-[#101919] text-[#f3f9fc]
