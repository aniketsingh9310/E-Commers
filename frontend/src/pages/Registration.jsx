...
const Registration = () => {
  ...
  return (
     <div className='w-screen h-screen bg-gradient-to-l from-[#141414] to-[#0c2825] text-white flex flex-col items-center justify-start'>
            ...
            <div className='max-w-[600px] w-[90%] h-[500px] bg-[#00000025] border-[1px] border-[#96969635] backdrop:blure-2xl rounded-lg shadow-lg
             flex items-center justify-center'>
                  <form action="" onSubmit={handleSignup} className='w-[90%] h-[90%] flex flex-col items-center justify-start gap-[20px]'>
                    ...
                    cursor-pointer' onClick={googleSignup}>
                          <img src={Google} alt="" className='w-[30px]'/>Registration with Google
                    </div>
                    <div className='w-[100%] h-[20px] flex items-center justify-center gap-[10px]'>
                        ...
                        <div className='w-[90%] h-[400px] flex flex-col items-center justify-center gap-[15px] relative'>
                            ...
                            <button className='w-[100%] h-[50px] bg-[#6060f5] rounded-lg flex items-center justify-center
                            mt-[20px] text-[17px] font-semibold'>Create Account</button>
                            <p className='flex gap-[10px]'>You have a any account? 
