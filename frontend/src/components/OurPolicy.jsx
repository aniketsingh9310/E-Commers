  ...
  <div className='w-[100vw] h-[100vh] md:h-[70vh] flex items-center justify-start
    ...
    <div className='w-[100%] md:min-h-[50%] h-[20%] flex items-center justify-center flex-wrap
        ...
        <div className='w-[400px] max-w-[90%] h-[60%] flex items-center justify-center flex-col gap-[10px]'>
            ...
            <p className='font-semibold md:text-[22px] text-[19px] text-[#a5e8f7]'>Easy Exchange Policy</p>
            <p className='font-semibold md:text-[15px] text-[12px] text-[aliceblue] text-center'>
                Exchange Made Easy - Quick Simple, and Customer-Frinedly Process.
            </p>
        </div>
         <div className='w-[400px] max-w-[90%] h-[60%] flex items-center justify-center flex-col gap-[10px]'>
            <TbRosetteDiscountCheckFilled className='md:w-[60px] w-[30px] h-[30px] md:h-[60px] text-[#90b9ff]'/>
            <p className='font-semibold md:text-[22px] text-[19px] text-[#a5e8f7]'>7 Days Return Policy</p>
            <p className='font-semibold md:text-[15px] text-[12px] text-[aliceblue] text-center'>
                Shop with Confidence- 7 Days Easy Return Guarantee and Promise.
            </p>
        </div>
         <div className='w-[400px] max-w-[90%] h-[60%] flex items-center justify-center flex-col gap-[10px]'>
            <BiSupport className='md:w-[60px] w-[30px] h-[30px] md:h-[60px] text-[#90b9ff]'/>
            <p className='font-semibold md:text-[22px] text-[19px] text-[#a5e8f7]'>Best Customer Support</p>
            <p className='font-semibold md:text-[15px] text-[12px] text-[aliceblue] text-center'>
